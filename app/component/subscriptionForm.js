	...
	return {
		...
		template: `<form ng-class="wrapperClass" ng-submit="submit($event)">
			...
			<select id="job" name="user_job" ng-model="appCtrl.userType">
				...
				<option>Fore Focus</option>
				<option>Fore Ford</option>
				<option>Fore Ford ford</option>				
			</select>
			
			 
     
          <label>Hình thức thanh toán:</label>
          <input required="required" type="radio" id="under_13" value="Trả Góp" ng-model="appCtrl.userCate" name="user_age"><label for="under_13" class="light">Trả Góp</label><br>
          <input type="radio" id="over_13" value="Trả Hết" ng-model="appCtrl.userCate" name="user_age"><label for="over_13" class="light">Trả hết</label>
			...
			<select id="area" name="user_area" ng-model="appCtrl.userArea">
